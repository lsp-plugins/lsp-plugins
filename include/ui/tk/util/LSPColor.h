    ...
    namespace tk
    {
        ...
        class LSPColor
        {
            ...
            protected:
                ...
                void            trigger_change(bool reset_default = true);
            ...
            public:
                ...
                /**
                 * Check whether the color is marked as default
                 * @return true if the color is marked as default
                 */
                inline bool is_default() const { return bDefault; }

                /**
                 * Mark the color as default, e.g. allow overriding
                 */
                inline void make_default() { bDefault = true; }

                /**
                 * Override the color value
                 * @param c color value
                 */
                void override(const LSPColor &c);
