    ...
    namespace tk
    {
        class LSPString
        {
            ...
            public:
                ...
                inline bool set_ascii(const char *s) { return set_utf8(s, strlen(s)); };
                 ...
                 *
                 */
                bool ends_with(lsp_wchar_t ch);
                bool ends_with(const LSPString *src);

                bool starts_with(lsp_wchar_t ch);
                bool starts_with(const LSPString *src);
