...
static inline void RESTORE_IMPL(float *dst, float *tmp, size_t rank)
{
...
//                __ASM_EMIT(".align 16")
        ...
        // Load data
        __ASM_EMIT(MV_TMP "     0x00(%[ptr]), %%xmm1")
        __ASM_EMIT(MV_TMP "     0x10(%[ptr]), %%xmm3")
        __ASM_EMIT(MV_TMP "     0x20(%[ptr]), %%xmm5")
        __ASM_EMIT(MV_TMP "     0x30(%[ptr]), %%xmm7")
        ...
        __ASM_EMIT(MV_TMP "     %%xmm0, 0x00(%[ptr])")
        __ASM_EMIT(MV_TMP "     %%xmm1, 0x10(%[ptr])")
        __ASM_EMIT(MV_TMP "     %%xmm4, 0x20(%[ptr])")
        __ASM_EMIT(MV_TMP "     %%xmm5, 0x30(%[ptr])")
