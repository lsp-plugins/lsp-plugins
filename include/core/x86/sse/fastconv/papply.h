...
static inline void APPLY_INTERNAL_IMPL(float *tmp, const float *conv, size_t rank)
{
...
//                __ASM_EMIT(".align 16")
        ...
        // Load data
        __ASM_EMIT(MV_TMP "     0x00(%[tmp]), %%xmm0")      /* xmm0 = r0 r1 r2 r3 */
        __ASM_EMIT(MV_TMP "     0x10(%[tmp]), %%xmm1")      /* xmm1 = i0 i1 i2 i3 */
        __ASM_EMIT(MV_TMP "     0x20(%[tmp]), %%xmm4")
        __ASM_EMIT(MV_TMP "     0x30(%[tmp]), %%xmm5")
        ...
        // xmm4 = r4 r5 r6 r7
        // xmm6 = i4 i5 i6 i7
        __ASM_EMIT(MV_CONV "    0x00(%[conv]), %%xmm1")     /* xmm1 = rc0 rc1 rc2 rc3 */
        __ASM_EMIT(MV_CONV "    0x10(%[conv]), %%xmm3")     /* xmm3 = ic0 ic1 ic2 ic3 */
        ...
        __ASM_EMIT(MV_CONV "    0x20(%[conv]), %%xmm0")     /* xmm0 = rc4 rc5 rc6 rc7 */
        __ASM_EMIT(MV_CONV "    0x30(%[conv]), %%xmm2")     /* xmm2 = ic4 ic5 ic6 ic7 */
