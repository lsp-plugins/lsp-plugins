...
#ifndef CORE_X86_SSE4_3DMATH_H_
#define CORE_X86_SSE4_3DMATH_H_

#ifndef CORE_X86_SSE4_IMPL
    #error "This header should not be included directly"
#endif /* CORE_X86_SSE4_IMPL */

namespace lsp
{
    namespace sse4
    {
        using namespace lsp::sse;
