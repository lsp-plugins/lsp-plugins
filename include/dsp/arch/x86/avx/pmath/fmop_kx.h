...
namespace avx
{
    ...
    #define FMADDSUB_KX_CORE(DST, SRC1, SRC2, OP) \
        ...
        __ASM_EMIT(OP "ps       0x000(%[" SRC2 "], %[off]), %%ymm0, %%ymm6") \
        __ASM_EMIT(OP "ps       0x020(%[" SRC2 "], %[off]), %%ymm1, %%ymm7") \
        __ASM_EMIT(OP "ps       0x040(%[" SRC2 "], %[off]), %%ymm0, %%ymm8") \
        __ASM_EMIT(OP "ps       0x060(%[" SRC2 "], %[off]), %%ymm1, %%ymm9") \
        ...
        __ASM_EMIT(OP "ps       0x000(%[" SRC2 "], %[off]), %%xmm0, %%xmm6") \
        ...
        __ASM_EMIT(OP "ss       0x000(%[" SRC2 "], %[off]), %%xmm0, %%xmm6") \
    ...
    void x64_fmadd_k3_fma3(float *dst, const float *src, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMADDSUB_KX_CORE("dst", "dst", "src", "vfmadd231")
    ...
    void x64_fmsub_k3_fma3(float *dst, const float *src, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMADDSUB_KX_CORE("dst", "dst", "src", "vfnmadd231")
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz"(k)
            : [dst] "r"(dst), [src] "r"(src)
            : "cc", "memory",
    ...
    void x64_fmrsub_k3_fma3(float *dst, const float *src, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMADDSUB_KX_CORE("dst", "dst", "src", "vfmsub231")
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz"(k)
            : [dst] "r"(dst), [src] "r"(src)
            : "cc", "memory",
    ...
    void x64_fmadd_k4_fma3(float *dst, const float *src1, const float *src2, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMADDSUB_KX_CORE("dst", "src1", "src2", "vfmadd231")
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz" (k)
    ...
    void x64_fmsub_k4_fma3(float *dst, const float *src1, const float *src2, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMADDSUB_KX_CORE("dst", "src1", "src2", "vfnmadd231")
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz" (k)
            : [dst] "r"(dst), [src1] "r" (src1), [src2] "r" (src2)
            : "cc", "memory",
    ...
    void x64_fmrsub_k4_fma3(float *dst, const float *src1, const float *src2, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMADDSUB_KX_CORE("dst", "src1", "src2", "vfmsub231")
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz" (k)
            : [dst] "r"(dst), [src1] "r" (src1), [src2] "r" (src2)
            : "cc", "memory",
    ...
    void x64_fmadd_k3(float *dst, const float *src, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "dst", "src", "vadd", OP_DSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz"(k)
            : [dst] "r"(dst), [src] "r"(src)
            : "cc", "memory",
    ...
    void x64_fmsub_k3(float *dst, const float *src, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "dst", "src", "vsub", OP_DSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz"(k)
            : [dst] "r"(dst), [src] "r"(src)
            : "cc", "memory",
    ...
    void x64_fmrsub_k3(float *dst, const float *src, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "dst", "src", "vsub", OP_RSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz"(k)
            : [dst] "r"(dst), [src] "r"(src)
            : "cc", "memory",
    ...
    void x64_fmmul_k3(float *dst, const float *src, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "dst", "src", "vmul", OP_DSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz"(k)
            : [dst] "r"(dst), [src] "r"(src)
            : "cc", "memory",
    ...
    void x64_fmdiv_k3(float *dst, const float *src, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "dst", "src", "vdiv", OP_DSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz"(k)
            : [dst] "r"(dst), [src] "r"(src)
            : "cc", "memory",
    ...
    void x64_fmrdiv_k3(float *dst, const float *src, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "dst", "src", "vdiv", OP_RSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz"(k)
            : [dst] "r"(dst), [src] "r"(src)
            : "cc", "memory",
    ...
    void x64_fmadd_k4(float *dst, const float *src1, const float *src2, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "src1", "src2", "vadd", OP_DSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz" (k)
            : [dst] "r"(dst), [src1] "r" (src1), [src2] "r" (src2)
            : "cc", "memory",
    ...
    void x64_fmsub_k4(float *dst, const float *src1, const float *src2, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "src1", "src2", "vsub", OP_DSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz" (k)
            : [dst] "r"(dst), [src1] "r" (src1), [src2] "r" (src2)
            : "cc", "memory",
    ...
    void x64_fmrsub_k4(float *dst, const float *src1, const float *src2, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "src1", "src2", "vsub", OP_RSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz" (k)
            : [dst] "r"(dst), [src1] "r" (src1), [src2] "r" (src2)
            : "cc", "memory",
    ...
    void x64_fmmul_k4(float *dst, const float *src1, const float *src2, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "src1", "src2", "vmul", OP_DSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz" (k)
            : [dst] "r"(dst), [src1] "r" (src1), [src2] "r" (src2)
            : "cc", "memory",
    ...
    void x64_fmdiv_k4(float *dst, const float *src1, const float *src2, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "src1", "src2", "vdiv", OP_DSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz" (k)
            : [dst] "r"(dst), [src1] "r" (src1), [src2] "r" (src2)
            : "cc", "memory",
    ...
    void x64_fmrdiv_k4(float *dst, const float *src1, const float *src2, float k, size_t count)
    {
        ...
        ARCH_X86_64_ASM
        (
            FMOP_KX_CORE("dst", "src1", "src2", "vdiv", OP_RSEL)
            : [off] "=&r" (off), [count] "+r" (count),
              [k] "+Yz" (k)
            : [dst] "r"(dst), [src1] "r" (src1), [src2] "r" (src2)
            : "cc", "memory",
