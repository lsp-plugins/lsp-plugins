...
namespace asimd
{
    float h_dotp(const float *a, const float *b, size_t count)
    {
        ...
        (
            ...
            /* end of sum */
            __ASM_EMIT("8:")
            __ASM_EMIT("ext         v1.16b, v16.16b, v16.16b, #8")
            __ASM_EMIT("fadd        v0.4s, v16.4s, v1.4s")
            __ASM_EMIT("ext         v1.16b, v0.16b, v0.16b, #4")
            __ASM_EMIT("fadd        %S[res].4s, v0.4s, v1.4s")
            : [res] "=w" (res),
