...
namespace asimd
{
    void pcomplex_mul2(float *dst, const float *src, size_t count)
    {
        ...
        (
            ...
            // x16 blocks
            __ASM_EMIT("1:")
            __ASM_EMIT("ld2         {v16.4s-v19.4s}, [%[src]], #0x40")      // v16, v18 = sr1, v17, v19 = si1
            __ASM_EMIT("ld2         {v24.4s-v27.4s}, [%[dst]], #0x40")      // v24, v26 = dr1, v25, v27 = di1
            __ASM_EMIT("ld2         {v20.4s-v23.4s}, [%[src]], #0x40")      // v20, v22 = sr2, v21, v23 = si2
            __ASM_EMIT("ld2         {v28.4s-v31.4s}, [%[dst]], #0x40")      // v28, v30 = dr2, v29, v31 = di2
            ...
            __ASM_EMIT("subs        %[count], %[count], #16")
            __ASM_EMIT("st2         {v0.4s-v3.4s}, [%[dst]], #0x40")
            __ASM_EMIT("st2         {v4.4s-v7.4s}, [%[dst]], #0x40")
            __ASM_EMIT("b.hs        1b")
            ...
            __ASM_EMIT("b.lt        4f")
            __ASM_EMIT("ld2         {v16.4s-v19.4s}, [%[src]], #0x40")      // v16, v18 = sr1, v17, v19 = si1
            __ASM_EMIT("ld2         {v24.4s-v27.4s}, [%[dst]]")             // v24, v26 = dr1, v25, v27 = di1
