...
#ifndef METADATA_MB_GATE_H_
#define METADATA_MB_GATE_H_

namespace lsp
{
    //-------------------------------------------------------------------------
    // Multiband gate
    struct mb_gate_base_metadata
    {
    ...
    struct mb_gate_mono_metadata: public mb_gate_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct mb_gate_stereo_metadata: public mb_gate_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct mb_gate_lr_metadata: public mb_gate_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct mb_gate_ms_metadata: public mb_gate_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct sc_mb_gate_mono_metadata: public mb_gate_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct sc_mb_gate_stereo_metadata: public mb_gate_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct sc_mb_gate_lr_metadata: public mb_gate_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct sc_mb_gate_ms_metadata: public mb_gate_base_metadata
    {
        static const plugin_metadata_t metadata;
    };
}

#endif /* METADATA_MB_GATE_H_ */
