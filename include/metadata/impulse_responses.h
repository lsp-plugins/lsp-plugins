...
#ifndef METADATA_IMPULSE_RESPONSES_H_
#define METADATA_IMPULSE_RESPONSES_H_
...
namespace lsp
{
    ...
    struct impulse_responses_mono_metadata: public impulse_responses_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct impulse_responses_stereo_metadata: public impulse_responses_base_metadata
    {
        static const plugin_metadata_t metadata;
    };
...
#endif /* METADATA_IMPULSE_RESPONSES_H_ */
