...
#ifndef METADATA_EXPANDER_H_
#define METADATA_EXPANDER_H_

namespace lsp
{
    //-------------------------------------------------------------------------
    // Expander
    struct expander_base_metadata
    {
    ...
    struct expander_mono_metadata: public expander_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct expander_stereo_metadata: public expander_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct expander_lr_metadata: public expander_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct expander_ms_metadata: public expander_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct sc_expander_mono_metadata: public expander_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct sc_expander_stereo_metadata: public expander_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct sc_expander_lr_metadata: public expander_base_metadata
    {
        static const plugin_metadata_t metadata;
    };

    struct sc_expander_ms_metadata: public expander_base_metadata
    {
        static const plugin_metadata_t metadata;
    };
