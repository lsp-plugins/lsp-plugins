<p>This plugin implements 48-instrument MIDI sampler with stereo input and stereo output. For each instrument there are up to eight samples available to play for different note velocities.
Also each instrument has it's own stereo output that makes possible to record instrument outputs into individual tracks.</p>
...
<ul>
	<li><b>Mixer Lines</b> - selects what mixer lines are currently displayed in the instrument mixer.</li>
