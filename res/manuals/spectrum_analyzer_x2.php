<p>This plugin performs spectral analysis of a pair of audio channels.
	It does not change the input signal, so can be placed anywhere where the metering is needed.
</p>
...
<ul>
	...
	<li><b>On</b> - turns on the analysis of the corresponding channel.</li>
	<li><b>Solo</b> - allows to individually inspect the corresponding channel.</li>
	<li><b>Hold</b> - forces the frequency graph of the corresponding channel to freeze.</li>
	<li><b>Hue</b> - allows to adjust the color (hue) of the corresponding channel.</li>
	<li><b>Shift</b> - allows to adjust the gain of the corresponding channel.</li>
...
<ul>
	...
	<li><b>Level</b> - the level of the selected <b>Frequency</b> for the channel specified by <b>Channel</b> control.</li>
</ul>
