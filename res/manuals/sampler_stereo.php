<p>This plugin implements single-note MIDI sampler with stereo input and stereo output. There are up to eight samples available to play for different note velocities.</p>
