...
LSP_PLUGINS_AB_TESTER_VERSION           := 1.0.3
...
LSP_PLUGINS_ART_DELAY_VERSION           := 1.0.12
...
LSP_PLUGINS_COMPRESSOR_VERSION          := 1.0.16
...
LSP_PLUGINS_CROSSOVER_VERSION           := 1.0.12
...
LSP_PLUGINS_DYNA_PROCESSOR_VERSION      := 1.0.15
...
LSP_PLUGINS_EXPANDER_VERSION            := 1.0.15
...
LSP_PLUGINS_GATE_VERSION                := 1.0.15
...
LSP_PLUGINS_GRAPH_EQUALIZER_VERSION     := 1.0.15
...
LSP_PLUGINS_IMPULSE_RESPONSES_VERSION   := 1.0.15
...
LSP_PLUGINS_IMPULSE_REVERB_VERSION      := 1.0.12
...
LSP_PLUGINS_LATENCY_METER_VERSION       := 1.0.11
...
LSP_PLUGINS_LIMITER_VERSION             := 1.0.13
...
LSP_PLUGINS_LOUD_COMP_VERSION           := 1.0.11
...
LSP_PLUGINS_MB_COMPRESSOR_VERSION       := 1.0.13
...
LSP_PLUGINS_MB_DYNA_PROCESSOR_VERSION   := 1.0.8
...
LSP_PLUGINS_MB_EXPANDER_VERSION         := 1.0.11
...
LSP_PLUGINS_MB_GATE_VERSION             := 1.0.11
...
LSP_PLUGINS_MIXER_VERSION             	:= 1.0.3
...
LSP_PLUGINS_NOISE_GENERATOR_VERSION     := 1.0.6
...
LSP_PLUGINS_OSCILLATOR_VERSION          := 1.0.11
...
LSP_PLUGINS_OSCILLOSCOPE_VERSION        := 1.0.11
...
LSP_PLUGINS_PARA_EQUALIZER_VERSION      := 1.0.16
...
LSP_PLUGINS_PHASE_DETECTOR_VERSION      := 1.0.11
...
LSP_PLUGINS_PROFILER_VERSION            := 1.0.11
...
LSP_PLUGINS_ROOM_BUILDER_VERSION        := 1.0.12
...
LSP_PLUGINS_SAMPLER_VERSION             := 1.0.15
...
LSP_PLUGINS_SPECTRUM_ANALYZER_VERSION   := 1.0.17
...
LSP_PLUGINS_SURGE_FILTER_VERSION        := 1.0.11
...
LSP_PLUGINS_TRIGGER_VERSION             := 1.0.13
