...
LSP_PLUGINS_ART_DELAY_VERSION           := 1.0.5
...
LSP_PLUGINS_COMP_DELAY_VERSION          := 1.0.7
...
LSP_PLUGINS_COMPRESSOR_VERSION          := 1.0.8
...
LSP_PLUGINS_CROSSOVER_VERSION           := 1.0.5
...
LSP_PLUGINS_DYNA_PROCESSOR_VERSION      := 1.0.7
...
LSP_PLUGINS_EXPANDER_VERSION            := 1.0.7
...
LSP_PLUGINS_GATE_VERSION                := 1.0.7
...
LSP_PLUGINS_GRAPH_EQUALIZER_VERSION     := 1.0.7
...
LSP_PLUGINS_IMPULSE_RESPONSES_VERSION   := 1.0.7
...
LSP_PLUGINS_IMPULSE_REVERB_VERSION      := 1.0.5
...
LSP_PLUGINS_LATENCY_METER_VERSION       := 1.0.4
...
LSP_PLUGINS_LIMITER_VERSION             := 1.0.6
...
LSP_PLUGINS_LOUD_COMP_VERSION           := 1.0.4
...
LSP_PLUGINS_MB_COMPRESSOR_VERSION       := 1.0.6
...
LSP_PLUGINS_MB_DYNA_PROCESSOR_VERSION   := 1.0.1
...
LSP_PLUGINS_MB_EXPANDER_VERSION         := 1.0.4
...
LSP_PLUGINS_MB_GATE_VERSION             := 1.0.4
...
LSP_PLUGINS_OSCILLOSCOPE_VERSION        := 1.0.4
...
LSP_PLUGINS_PARA_EQUALIZER_VERSION      := 1.0.8
...
LSP_PLUGINS_PHASE_DETECTOR_VERSION      := 1.0.4
...
LSP_PLUGINS_PROFILER_VERSION            := 1.0.4
...
LSP_PLUGINS_ROOM_BUILDER_VERSION        := 1.0.5
...
LSP_PLUGINS_SAMPLER_VERSION             := 1.0.7
...
LSP_PLUGINS_SLAP_DELAY_VERSION          := 1.0.5
...
LSP_PLUGINS_SPECTRUM_ANALYZER_VERSION   := 1.0.8
...
LSP_PLUGINS_SURGE_FILTER_VERSION        := 1.0.4
...
LSP_PLUGINS_TRIGGER_VERSION             := 1.0.6
