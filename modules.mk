...
LSP_PLUGINS_AB_TESTER_VERSION           := 1.0.17
...
LSP_PLUGINS_ART_DELAY_VERSION           := 1.0.26
...
LSP_PLUGINS_AUTOGAIN_VERSION            := 1.0.11
...
LSP_PLUGINS_BEAT_BREATHER_VERSION       := 1.0.14
...
LSP_PLUGINS_CHORUS_VERSION              := 1.0.7
...
LSP_PLUGINS_CLIPPER_VERSION             := 1.0.9
...
LSP_PLUGINS_COMP_DELAY_VERSION          := 1.0.29
...
LSP_PLUGINS_COMPRESSOR_VERSION          := 1.0.30
...
LSP_PLUGINS_CROSSOVER_VERSION           := 1.0.26
...
LSP_PLUGINS_DYNA_PROCESSOR_VERSION      := 1.0.29
...
LSP_PLUGINS_EXPANDER_VERSION            := 1.0.29
...
LSP_PLUGINS_FILTER_VERSION             	:= 1.0.14
...
LSP_PLUGINS_FLANGER_VERSION             := 1.0.14
...
LSP_PLUGINS_GATE_VERSION                := 1.0.29
...
LSP_PLUGINS_GOTT_COMPRESSOR_VERSION     := 1.0.14
...
LSP_PLUGINS_GRAPH_EQUALIZER_VERSION     := 1.0.29
...
LSP_PLUGINS_IMPULSE_RESPONSES_VERSION   := 1.0.29
...
LSP_PLUGINS_IMPULSE_REVERB_VERSION      := 1.0.26
...
LSP_PLUGINS_LATENCY_METER_VERSION       := 1.0.25
...
LSP_PLUGINS_LIMITER_VERSION             := 1.0.27
...
LSP_PLUGINS_MB_CLIPPER_VERSION       	:= 1.0.9
...
LSP_PLUGINS_MB_COMPRESSOR_VERSION       := 1.0.27
...
LSP_PLUGINS_MB_DYNA_PROCESSOR_VERSION   := 1.0.22
...
LSP_PLUGINS_MB_EXPANDER_VERSION         := 1.0.25
...
LSP_PLUGINS_MB_GATE_VERSION             := 1.0.25
...
LSP_PLUGINS_MB_LIMITER_VERSION          := 1.0.14
...
LSP_PLUGINS_MIXER_VERSION             	:= 1.0.17
...
LSP_PLUGINS_NOISE_GENERATOR_VERSION     := 1.0.20
...
LSP_PLUGINS_OSCILLATOR_VERSION          := 1.0.25
...
LSP_PLUGINS_OSCILLOSCOPE_VERSION        := 1.0.25
...
LSP_PLUGINS_PARA_EQUALIZER_VERSION      := 1.0.30
...
LSP_PLUGINS_PHASE_DETECTOR_VERSION      := 1.0.25
...
LSP_PLUGINS_PROFILER_VERSION            := 1.0.25
...
LSP_PLUGINS_REFERENCER_VERSION          := 1.0.2
...
LSP_PLUGINS_RETURN_VERSION              := 1.0.4
...
LSP_PLUGINS_ROOM_BUILDER_VERSION        := 1.0.26
...
LSP_PLUGINS_SAMPLER_VERSION             := 1.0.29
...
LSP_PLUGINS_SEND_VERSION                := 1.0.4
...
LSP_PLUGINS_SLAP_DELAY_VERSION          := 1.0.26
...
LSP_PLUGINS_SPECTRUM_ANALYZER_VERSION   := 1.0.31
...
LSP_PLUGINS_SURGE_FILTER_VERSION        := 1.0.25
...
LSP_PLUGINS_TRIGGER_VERSION             := 1.0.27
