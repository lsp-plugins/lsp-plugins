...
namespace lsp
{
    ...
    #define SA_COMMON(c, modes) \
        BYPASS, \
        COMBO("mode", "Analyzer mode", 0, modes), \
    ...
    {
        SA_INPUT(0, 1),
        SA_COMMON(1, spectrum_analyzer_x1_modes),
        PORTS_END
    };
    ...
    static const port_t spectrum_analyzer_x2_ports[] =
    {
        SA_INPUT(0, 2),
        SA_INPUT(1, 2),
        SA_COMMON(2, spectrum_analyzer_x2_modes),
        PORTS_END
    };
    ...
    static const port_t spectrum_analyzer_x4_ports[] =
    {
        ...
        SA_INPUT(2, 4),
        SA_INPUT(3, 4),
        SA_COMMON(4, spectrum_analyzer_x4_modes),
        PORTS_END
    };
    ...
    static const port_t spectrum_analyzer_x8_ports[] =
    {
        ...
        SA_INPUT(6, 8),
        SA_INPUT(7, 8),
        SA_COMMON(8, spectrum_analyzer_x8_modes),
        PORTS_END
    };
    ...
    static const port_t spectrum_analyzer_x12_ports[] =
    {
        ...
        SA_INPUT(10, 12),
        SA_INPUT(11, 12),
        SA_COMMON(12, spectrum_analyzer_x12_modes),
        PORTS_END
    };
    ...
    static const port_t spectrum_analyzer_x16_ports[] =
    {
        ...
        SA_INPUT(14, 16),
        SA_INPUT(15, 16),
        SA_COMMON(16, spectrum_analyzer_x16_modes),
        PORTS_END
    };
