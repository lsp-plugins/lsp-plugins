...
namespace lsp
{
    namespace tk
    {
        ...
        bool LSPString::ends_with(lsp_wchar_t ch)
        {
            if (nLength <= 0)
                return false;
        ...
        bool LSPString::ends_with(const LSPString *src)
        {
            if (src->nLength <= 0)
                return true;
        ...
        bool LSPString::starts_with(lsp_wchar_t ch)
        {
            if (nLength <= 0)
                return false;
            return pData[0] == ch;
        ...
        bool LSPString::starts_with(const LSPString *src)
        {
            if (src->nLength <= 0)
                return true;
            ...
            return xcmp(pData, src->pData, src->nLength) == 0;
        }
