...
<p>
	This plugin performs multiband gating of of <?= $cc ?> input signal<?php 
...
<ul>
	...
	<li><b>Controls</b> - set of buttons that control the behaviour of the gate:</li>
	<ul>
		<li><b>On</b> - enables gate assigned to the corresponding frequency band.</li>
	...
	<li><b>Makeup</b> - applies additional gain to the output of the corresponding gate.</li>
	<li><b>Attack</b> - allows to set the attack time for the gate.</li>
	<li><b>Release</b> - allows to set the release time for the gate.</li>
	<li><b>Thresh</b> - allows to set main threshold of the gate.</li>
	<li><b>Zone</b> - allows to set the size of transition zone between fully reduced and non-reduced signals.</li>
</ul>
<?php if ($m == 'lr') {?>
	<p><b>'Band N' section</b> - allows to simultaneously control all parameters of gates of Left and Right
	channels assigned to the selected frequency band:</p>
<?php } elseif ($m == 'ms') {?>
	<p><b>'Band N' section</b> - allows to simultaneously control all parameters of gates of Middle and Side
	channels assigned to the selected frequency band:</p>
<?php } else {?>
...
<ul>
	...
	<li><b>Gate On</b> - enables Gate assigned to the corresponding frequency band.</li>
	<li><b>Gate Solo</b> - turns on soloing mode to the selected band by applying -36 dB gain to non-soloing bands</li>
	<li><b>Gate Mute</b> - turns on muting mode to the selected band by applying -36 dB gain to it</li>
	<li><b>Gate Reduction</b> - the maximum available gain reduction for the gate.</li>
