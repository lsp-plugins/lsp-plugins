...
<b>Window</b> -> <b>Perspective</b> -> <b>Open Perspective</b> -> <b>Other...</b></p>
<div class="images">
	<img src="<?= $IMG ?>eclipse-cpp-perspective.png">
</div>

<p>After switching to C/C++ perspective, select <b>File</b> -> <b>New</b> -> <b>C/C++ Project</b></p>
<p>In the opened dialog, select <b>C++ Managed Build</b> template, then click <b>Next</b></p>
<div class="images">
	<img src="<?= $IMG ?>eclipse-cpp-template.png">
</div>

<p>Enter the folder name same to the folder of the GIT repository, select <b>Executable</b> -> <b>Empty Project</b>,
...
<p>Go to <b>C/C++ Build</b> -> <b>Settings</b> and, first of all, select <b>Configuration</b> combo
to <b>[ All Configurations ]</b>, this will apply all modified settings to all build targets.</p>
<p>Select <b>GCC C++ Compiler</b> -> <b>Dialect</b> section and select the <b>ISO C++98</b> as a <b>Language Standard</b>:</p>
<div class="images">
	<img src="<?= $IMG ?>eclipse-project-lang-std.png">
</div>

<p>Select <b>GCC C++ Compiler</b> -> <b>Preprocessor</b> section and add following macros to <b>Defined Symbols</b>:</p>
<ul>
...
<p>Now we need to define additional location of header files. Select <b>GCC C++ Compiler</b> -> <b>Includes</b>
...
<p>Now we need to enable extra headers for additional packages, for this purpose visit <b>GCC C++ Compiler</b> -> <b>Miscellaneous</b>
...
<p>Select <b>GCC C++ Linker</b> -> <b>General</b> settings and enable the <b>Support for pthread (-pthread)</b> option:<p>
<div class="images">
...
<p>Select <b>GCC C++ Linker</b> -> <b>Miscellaneous</b> settings and enter the following string to <b>Linker flags</b> field
...
For this purpose, visit <b>Resource</b> -> <b>Resource Filters</b>, click <b>Add Filter</b></p>
...
<b>C/C++ Build</b> -> <b>Behavior</b> and click <b>Enable Parallel Build</b>, <b>Use optimal jobs</b>:</p>
<div class="images">
	<img src="<?= $IMG ?>eclipse-project-build.png">
</div>

<p>Now we can click <b>Apply and Close</b> button and launch build by issuing <b>Project</b> -> <b>Build</b> menu item.</p>

<h2>Debugging Project</h2>

<p>To start debugging, simply issue <b>Run</b> -> <b>Debug as</b> -> <b>Local C/C++ Application</b>, Eclipse IDE will
...
<p>Now we can edit configuration by selecting <b>Run</b> -> <b>Debug Configurations...</b> and pass additional
