...
PTEST_BEGIN("dsp.pmath", op_k3, 5, 1000)
    ...
    PTEST_MAIN
    {
        ...
        for (size_t i=MIN_RANK; i <= MAX_RANK; ++i)
        {
            ...
            IF_ARCH_X86(CALL(avx2::rdiv_k3));
            IF_ARCH_ARM(CALL(neon_d32::rdiv_k3));
            IF_ARCH_AARCH64(CALL(asimd::rdiv_k3));
            PTEST_SEPARATOR;

            CALL(native::mod_k3);
            IF_ARCH_X86(CALL(sse2::mod_k3));
            IF_ARCH_X86(CALL(avx::mod_k3));
            IF_ARCH_X86(CALL(avx::mod_k3_fma3));
            ...
            CALL(native::rmod_k3);
            IF_ARCH_X86(CALL(sse2::rmod_k3));
            IF_ARCH_X86(CALL(avx::rmod_k3));
            IF_ARCH_X86(CALL(avx::rmod_k3_fma3));
