...
typedef void (* conv_fft_t)(float *dst, const float *src, size_t rank);

UTEST_BEGIN("dsp.fft", cfft)

    void call(const char *label, size_t align, conv_fft_t func1, conv_fft_t func2)
    {
