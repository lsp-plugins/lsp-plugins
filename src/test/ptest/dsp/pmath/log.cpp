...
PTEST_BEGIN("dsp.pmath", log, 5, 1000)
    ...
    PTEST_MAIN
    {
        ...
        for (size_t i=MIN_RANK; i <= MAX_RANK; ++i)
        {
            ...
            IF_ARCH_X86(CALL("avx2::x64_logb1", dst, src, count, avx2::x64_logb1));
            IF_ARCH_X86(CALL("avx2::x64_logb1_fma3", dst, src, count, avx2::x64_logb1_fma3));
            ...
            IF_ARCH_X86(CALL("avx2::x64_logb2", dst, src, count, avx2::x64_logb2));
            IF_ARCH_X86(CALL("avx2::x64_logb2_fma3", dst, src, count, avx2::x64_logb2_fma3));
            ...
            IF_ARCH_X86(CALL("avx2::x64_loge1", dst, src, count, avx2::x64_loge1));
            IF_ARCH_X86(CALL("avx2::x64_loge1_fma3", dst, src, count, avx2::x64_loge1_fma3));
            ...
            IF_ARCH_X86(CALL("avx2::x64_loge2", dst, src, count, avx2::x64_loge2));
            IF_ARCH_X86(CALL("avx2::x64_loge2_fma3", dst, src, count, avx2::x64_loge2_fma3));
            ...
            IF_ARCH_X86(CALL("avx2::x64_logd1", dst, src, count, avx2::x64_logd1));
            IF_ARCH_X86(CALL("avx2::x64_logd1_fma3", dst, src, count, avx2::x64_logd1_fma3));
            ...
            IF_ARCH_X86(CALL("avx2::x64_logd2", dst, src, count, avx2::x64_logd2));
            IF_ARCH_X86(CALL("avx2::x64_logd2_fma3", dst, src, count, avx2::x64_logd2_fma3));
